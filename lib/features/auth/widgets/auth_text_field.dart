        ...
        decoration: BoxDecoration(
          ...
          boxShadow:
              _focus.hasFocus
                  ? [
                    BoxShadow(
                      color: AuthColors.fieldFocusBorder.withValues(
                        alpha: 0.12,
                      ),
                      blurRadius: 0,
                      spreadRadius: 3,
          ...
          decoration: InputDecoration(
            ...
            suffixIcon:
                ...
                (_isValid
                    ...
                    : null),
            filled: true,
            fillColor: _hasError ? const Color(0xFFFFF5F5) : AuthColors.fieldBg,
            ...
            errorStyle: const TextStyle(color: AuthColors.error, fontSize: 12),
...
class _AuthPasswordFieldState extends State<AuthPasswordField> {
  ...
  int _calcStrength(String v) {
    ...
    if (v.contains(RegExp(r'[0-9]')) || v.contains(RegExp(r'[^a-zA-Z0-9]')))
      s++;
    return s;
  }
