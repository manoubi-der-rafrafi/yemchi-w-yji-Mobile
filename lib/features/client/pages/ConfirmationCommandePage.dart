      ...
      children: [
        ...
        Row(
          children: [
            ...
            IconButton(onPressed: () => print("TODO: Geoloc depart"), icon: const Icon(Icons.location_on)),
            IconButton(onPressed: () => print("TODO: Map Picker depart"), icon: const Icon(Icons.map)),
          ],
        ),
      ...
      children: [
        ...
        Row(
          children: [
            ...
            // Stubs
            IconButton(onPressed: () => print("TODO: Map Picker arrivee"), icon: const Icon(Icons.map)),
          ],
        ),
        const SizedBox(height: 20),
